//
//  WeatherManagement.swift
//  Clima
//
//  Created by Lorena on 14/06/23.
...
struct WeatherManager {
    let weatherURL =  "https://api.openweathermap.org/data/2.5/weather?appid=96569605121e004bdc1dc6f8259227f4&units=metric"
